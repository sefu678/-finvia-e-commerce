...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Load products - only generate if explicitly needed by admin
  const savedProducts = localStorage.getItem("products")
  const adminInitialized = localStorage.getItem("adminInitialized")

  if (!savedProducts && !adminInitialized) {
    // First time setup - generate initial products
    ...
    // Admin has initialized but no products - start with empty array
    products = []
  }
...
function getWebsiteSettings() {
  ...
  return {
    ...
    footerDescription:
      ...
      "Premium Kurta Collection celebrating traditional Indian fashion with contemporary elegance.",
    socialLinks: {
      instagram: "#",
      facebook: "#",
      pinterest: "#",
...
function saveWebsiteSettings(event) {
  ...
  localStorage.setItem("adminModified", "true")
